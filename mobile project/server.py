...
Or: uvicorn server:app --reload --host 127.0.0.1 --port 8000
"""
...
async def admin_panel():
    ...
    admin_panel_path = os.path.join(BASE_DIR, "admin_panel.html")
    try:
        with open(admin_panel_path, "r", encoding="utf-8") as f:
            return HTMLResponse(content=f.read())
    except FileNotFoundError:
        return HTMLResponse(
            content=f"<html><body><h1>Admin Panel Not Found</h1></body></html>",
            status_code=404
        )
